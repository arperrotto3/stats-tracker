        ...
        <div className="register-card" style={{
          ...
          {success ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <h1 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '2rem', letterSpacing: '0.1em', color: '#F0E6D3', margin: '0 0 0.5rem' }}>CHECK YOUR EMAIL</h1>
              <p style={{ color: '#a0a0b0', fontWeight: 600, lineHeight: 1.6, marginBottom: '2rem' }}>We sent a verification link to <span style={{ color: '#C89B3C' }}>{email}</span>. Click the link to activate your account.</p>
              <a href="/login" style={{
            ...
            <div>
              <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                <h1 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '2.2rem', letterSpacing: '0.1em', margin: '0 0 0.5rem', color: '#F0E6D3' }}>CREATE ACCOUNT</h1>
                <p style={{ color: '#a0a0b0', fontSize: '1rem', margin: 0, fontWeight: 550 }}>Start tracking your stats today</p>
              </div>
