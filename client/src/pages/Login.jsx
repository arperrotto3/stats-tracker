      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '6rem 1rem 2rem' }}>
        <div className="login-card" style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <h1 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '2.2rem', letterSpacing: '0.1em', margin: '0 0 0.5rem', color: '#F0E6D3' }}>WELCOME BACK</h1>
            <p style={{ color: '#a0a0b0', fontSize: '1.05rem', margin: 0, fontWeight: 550 }}>Sign in to your account</p>
          </div>
          ...
          <p style={{ textAlign: 'center', color: '#a0a0b0', marginTop: '1.5rem', fontSize: '1rem' , fontWeight: 550 }}>
            Don't have an account? <a href="/register" style={{ color: '#C89B3C', textDecoration: 'none', fontWeight: 600 }}>Create one</a>
          </p>
        </div>
      </div>
    </div>
